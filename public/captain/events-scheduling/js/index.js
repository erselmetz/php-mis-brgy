$(function () {
    try {
                ...
                <div class="w-full text-left border p-3 rounded-lg bg-white hover:border-theme-primary cursor-pointer event-item"
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-1 ml-2">
                            <button class="edit-event-btn text-blue-600 hover:text-blue-800 text-xs px-2 py-1" data-id="${event.id}">View</button>
                        </div>
                    </div>
                </div>
            `;
            ...
            try {
                ...
                for (let day = 1; day <= daysInMonth; day++) {
                    ...
                    if (dayEvents.length > 0) {
                        ...
                        ${day}
                        <span class="absolute top-0 right-2 text-xs">${dayEvents.length}</span>
                    </div>`;
                    }
        ...
        $(document).on("click", ".event-item", function (e) {
            if ($(e.target).closest(".edit-event-btn, .delete-event-btn").length) {
        ...
        // 👇 Attach listener for real-time search
