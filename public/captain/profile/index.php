...
<body class="bg-gray-100 h-screen overflow-hidden" style="display:none;">
    ...
    <script>
        ...
        function loadFileReports() {
            ...
            fetch('/captain/profile/file_reports.php?t=' + Date.now(), { cache: 'no-store' })
                .then(r => r.json())
                .then(data => {
        ...
        function triggerBackup() {
            ...
            form.method = 'POST';
            form.action = '/captain/profile/backup.php';
        ...
        function loadBackupHistory() {
            ...
            // cache: 'no-store' forces a fresh network request every time
            fetch('/captain/profile/backup_history.php?t=' + Date.now(), { cache: 'no-store' })
                .then(r => r.json())
                .then(data => {
                    if (data.status !== 'ok' || !data.data.length) {
