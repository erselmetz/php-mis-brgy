...
$reports = [
    [
        ...
        'print_url'    => '/captain/profile/file_reports_print.php?report=residents',
    ],
    [
        'key'          => 'officers',
        ...
        'print_url'    => '/captain/profile/file_reports_print.php?report=officers',
    ],
    [
        'key'          => 'blotter',
        'label'        => 'Blotter',
        ...
        'print_url'    => '/captain/profile/file_reports_print.php?report=blotter',
    ],
    [
        'key'          => 'inventory',
        'label'        => 'Inventory',
        ...
        'print_url'    => '/captain/profile/file_reports_print.php?report=inventory',
    ],
];
