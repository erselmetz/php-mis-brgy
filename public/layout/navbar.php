        <nav class="bg-blue-700 text-white p-4 flex justify-between items-center relative shadow-lg">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-200">Barangay Bombongan</p>
                </div>
            </div>

            <!-- Right: Profile Dropdown -->
            <div class="relative">
                <button id="userDropdownBtn" class="flex items-center bg-blue-800 px-3 py-2 rounded-lg hover:bg-blue-900 focus:outline-none transition-all duration-200 shadow-md hover:shadow-lg">
                    <?php 
                ...
                <div id="userDropdown"
                    ...
                    <a href="/profile" class="block px-4 py-2 hover:bg-blue-50 transition-colors duration-150">Profile Account</a>
                    <?php if ($_SESSION['role'] == "admin") {
                        echo "<a href='/admin/account' class='block px-4 py-2 hover:bg-blue-50 transition-colors duration-150'>Manage Account</a>";
                    } ?>
