        <nav class="text-white p-4 flex justify-between items-center relative shadow-lg" style="background-color: var(--theme-primary);">
            ...
            <div class="relative">
                ...
                <div id="userDropdown"
                    ...
                    <a href="/kagawad/profile/" class="block px-4 py-2 hover-theme-light transition-colors duration-150 theme-link">Profile Account</a>
