                    ...
                    <tbody>
                        <?php if ($result !== false): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    <td class="p-2">
                                        <a href="/blotter/view.php?id=<?= $row['id'] ?>" class="text-theme-accent hover:underline font-semibold">
                                    ...
                                    <td class="p-2">
                                        <a href="/blotter/view.php?id=<?= $row['id'] ?>" class="text-theme-accent hover:underline">View</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
