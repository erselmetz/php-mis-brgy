...
<head>
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .type-tab:hover { color:var(--ink); border-bottom-color:var(--rule-dk); }
    ...
    .pb-sub:focus { border-color:var(--accent); }
    ...
    .pb-clear {
        ...
        color:var(--ink-muted); font-size:10.5px; font-weight:700;
    ...
    .rec-count {
        ...
        font-family:var(--f-mono); font-size:9.5px; color:var(--accent);
        letter-spacing:.4px;
    }
    ...
    .view-header {
        padding:16px 22px;
        background:var(--accent-lt); border-bottom:1px solid var(--rule);
    ...
    .view-section-title {
        ...
        color:var(--ink-faint); display:flex; align-items:center; gap:8px; margin-bottom:12px;
    }
    ...
    <div class="flex h-full" style="background:var(--bg);">
        ...
        <main class="flex-1 h-screen overflow-y-auto hr-page">
            ...
            <div class="doc-header">
                <div class="doc-header-inner">
                    <div>
                        ...
                        <div class="doc-title">
                            <span class="doc-title-icon"><?= $pageIcon ?></span>
                            <?= htmlspecialchars($pageTitle) ?>
                        </div>
                        <div class="doc-sub">Health program consultations and visit records</div>
                    </div>
            ...
            <div class="filter-bar">
                ...
                <button class="pb-btn <?= $period==='all'     ? 'active':'' ?>" data-period="all">All</button>
                ...
                <input type="month" class="pb-month" id="monthPicker" value="<?= htmlspecialchars($month) ?>"
                       <?= $period !== 'monthly' ? 'style="opacity:.45;"' : '' ?>>
                ...
                <input type="text" class="pb-search" id="searchInput"
                       placeholder="Search patient name…" value="<?= htmlspecialchars($q) ?>">
            ...
            <div class="hr-table-wrap">
                <div id="hrEmptyState" class="empty-state" style="display:none;">
                    ...
                    <div class="empty-text">No records found for the selected filters.</div>
                </div>
