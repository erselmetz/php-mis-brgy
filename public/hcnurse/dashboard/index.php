        ...
        <div class="bg-white p-6 shadow-sm rounded-xl mb-6 border border-gray-200">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex items-center p-4 rounded-lg bg-gray-50 border border-gray-200 cursor-pointer hover:bg-gray-100 transition" data-filter="total">
              <div class="p-3 bg-theme-secondary rounded-full text-theme-accent">
      ...
      function displayData(data, filter, role) {
        try {
          ...
          data.forEach(function(item) {
            tableHtml += '<tr>';
            if (isBlotterData) {
              tableHtml += '<td><a href="/blotter/view.php?id=' + item.id + '" class="text-theme-accent hover:underline">' + escapeHtml(item.case_number || '') + '</a></td>';
              ...
              tableHtml += '<td><a href="/resident/view.php?id=' + item.id + '" class="text-theme-accent hover:underline">' + fullName + '</a></td>';
        ...
        function renderGenderChart() {
          ...
          const config = {
            ...
            data: {
              ...
              datasets: [{
                data: data,
                backgroundColor: [getComputedStyle(document.documentElement).getPropertyValue('--theme-secondary').trim() || '#446c3e', '#ec4899', '#6b7280']
              }]
            },
            options: {
              responsive: true,
          ...
          const config = {
            ...
            data: {
              ...
              datasets: [{
                label: 'Cases',
                data: data,
                backgroundColor: ['#f59e0b', getComputedStyle(document.documentElement).getPropertyValue('--theme-secondary').trim() || '#446c3e', '#10b981', '#9ca3af']
              }]
            },
            options: {
              responsive: true,
        ...
        function renderVoterChart() {
          ...
          const config = {
            ...
            data: {
              ...
              datasets: [{
                data: data,
                backgroundColor: [themeSecondary, '#ef4444', '#6b7280']
              }]
            },
            options: {
              responsive: true,
