        ...
        <div class="form-body">
            <form id="certRequestForm">
                ...
                <div class="field-grp">
                    ...
                    <input disabled class="field-inp" type="text" id="certPurposeInput" name="purpose"
                        placeholder="e.g., Employment, Scholarship, Travel…" autocomplete="off">
                </div>

                <div id="formMessage" class="form-msg"></div>

                <button disabled type="submit" class="submit-btn" id="certSubmitBtn">Submit Request</button>
            </form>
        </div>
    </div>
            ...
            <table class="hist-tbl">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <button class="act-btn btn-print" onclick="printCertificate(<?= $row['id'] ?>)">view</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
